...
public sealed class KioskStockPolicy : IStockPolicy
{
    private readonly ApplicationDbContext _db;

    public KioskStockPolicy(ApplicationDbContext db) => _db = db;

    public string BusinessType => BusinessTypeNames.Kiosco;
